...
export const buildToolSystemNote = ({ tags = [] } = {}) => {
  const lines = [
    ...
    '',
    'MINH BẠCH KHI DÙNG TOOL — BẮT BUỘC áp dụng cho TẤT CẢ tool:',
    '  1. TRƯỚC khi gọi tool: thông báo ngắn gọn cho user biết bạn đang làm gì và với',
    '     đầu vào nào.',
    '     Ví dụ: "Tôi sẽ tìm email với từ khóa \'thầy Hùng\' (search_emails)..."',
    '     Ví dụ: "Đang lấy chi tiết email này (get_email)..."',
    '     Ví dụ: "Tìm tin tức về học bổng trên web (web_search)..."',
    '  2. SAU khi tool trả kết quả: tóm tắt ngắn kết quả trước khi trả lời chi tiết.',
    '     Ví dụ: "Tìm được 3 email từ thầy Hùng tuần này. Nội dung tóm tắt: ..."',
    '     Ví dụ: "Email đã đọc, nội dung chính là: ..."',
    '     Ví dụ: "Tìm được 2 bài tin tức về học bổng: ..."',
    '  Mục tiêu: user luôn biết bạn đang dùng công cụ gì, tìm kiếm gì, và thu được gì.',
    '',
